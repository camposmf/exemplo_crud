...
<body>
    <div class="container d-flex flex-column vh-100 justify-content-around">
        ...
        <header class="form-control form-label text-center">
            <h2>Get an especific user to UPDATE</h2>
        </header>
        <div>

            <form action="./get-user-update.php" method="post">
            ...
            <form action="../pages/update-user.php" method="POST">
                        ...
                        <?php
                            if(!empty($user)){
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td scope='row'><button type='submit' class='btn btn-warning'>Update</button></td>";
                                echo "</tr>";
                            }
                        ?>
                    </tbody>
